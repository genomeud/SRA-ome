...
READDIR=/projects/populus/ep/share/marroni/EOSC/reads/Metatranscriptomics
...
#From newer to older
myd_rev=`echo "module load it/lang/r/3.6.1; Rscript /projects/populus/ep/share/marroni/functions/EOSC/02_download_metrans_SRA.r \

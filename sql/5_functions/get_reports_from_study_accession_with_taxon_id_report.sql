create or replace function get_reports_from_study_accession_with_taxon_id_report(
...
begin
    ...
    where
        ST.StudyAccession   = _study_accession and
        RT.TaxonID          = _taxon_id
